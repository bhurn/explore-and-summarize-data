...
p7 <- ggplot(aes(x = sulphates, y = quality), data = reds) +
  ...
  annotate("text", x = 1.125, y = 3.5, label = "Corr: 0.251")
...
```{r echo=FALSE, warning=FALSE, fig.width = 8, Multivariate_Plots}
